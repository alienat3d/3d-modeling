...
// ! [начинаем смотреть отсюда] 23:00
export const sendFormFunc = ({ formId, someElems = [] }) => {
	...
	form.addEventListener('submit', (evt) => {
		...
		// * 5.0 Было бы неплохо также очищать все инпуты, после отсылки формы. Сделать это лучше всего в then, промиса sendData(). Для этого просто переберём все инпуты формы и почистим их value. Инпуты мы уже получили в константу formElements.
